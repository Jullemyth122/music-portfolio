...
import { CircleProps } from '@/props/CanvasProps'
...
function Planes({ color, ...props }: CircleProps) {
    ...
    useFrame((state,delta) => {
        ...
        planeRef.current.material.uniforms.u_time.value += time
            ...
            >
                ...
                <shaderMaterial
                    uniforms={{
                        ...
                        u_resolution: { value: new THREE.Vector2() } as THREE.IUniform<THREE.Vector2>,
                        u_mouse: { value: new THREE.Vector2() } as THREE.IUniform<THREE.Vector2>
                    }}
                    fragmentShader={`
                        #ifdef GL_ES
